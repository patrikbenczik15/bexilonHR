...
import documentRequestTypeRoutes from "./DocumentRequestTypeRoute.ts";
import documentRequestRoutes from "./DocumentRequestRoute.ts";
import authRoutes from "./AuthRoute.ts";
