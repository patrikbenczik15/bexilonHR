...
const items = [
  {
    ...
    description:
      "Keep every file organized and visible in real time—no more lost paperwork or blind spots.",
    imageLight: `url("${
  ...
  },
  {
    ...
    description:
      "Streamline sign-offs with configurable workflows that send reminders and log every decision.",
    imageLight: `url("${
      import.meta.env.VITE_TEMPLATE_IMAGE_URL
  ...
  },
  {
    ...
    description:
      "Unlock team performance metrics and compliance reports at a glance, right on your dashboard.",
    imageLight: `url("${
      import.meta.env.VITE_TEMPLATE_IMAGE_URL
